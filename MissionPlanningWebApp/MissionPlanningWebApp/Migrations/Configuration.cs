    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MissionPlanningWebApp.Models.LtLDbContext>
    {
        ...
        protected override void Seed(LtLDbContext context)
        {
			...
			var equipment = new List<Equipment>()
			{
				...
				new Equipment { Name = "M249", Weight = 15.3, Firepower = 3.0, Category = "Weapons and Ammunition"},
				new Equipment { Name = "M203", Weight = 3.0, Firepower = 4.0, Category = "Weapons and Ammunition"},
				...
				new Equipment { Name = "Ballistic Eye Wear", Weight = 0.15, Firepower = 3.0, Category = "Clothing and Armor"},
			...
			{
				new MissionParameter { Name = "Duration (hrs)", Value = 15, IsSelected = true },
				new MissionParameter { Name = "Threat level (0-500)", Value = 150, IsSelected = true },
				new MissionParameter { Name ="Expected Enemy Contact: None(0), Light(1), Medium(2), Heavy(3)", Value = 1, IsSelected = true },
			...
			{
				new Warfighter { Name = "Johnson", Weight = 166.7, IsSelected = true },
				new Warfighter { Name = "Smith", Weight = 175.4, IsSelected = true },
				new Warfighter { Name = "Miller", Weight = 159.2, IsSelected = true },
				new Warfighter { Name = "Perkins", Weight = 162.0, IsSelected = true },
				new Warfighter { Name = "Turner", Weight = 179.2, IsSelected = true },
				new Warfighter { Name = "Williams", Weight = 151.0, IsSelected = true }
			};
			...
			{
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 12, EquipId = equipment.First(e => e.Name == "MRE").ID, ConstrCond = ">", ConstrRHS = 12 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 22, EquipId = equipment.First(e => e.Name == "MRE").ID, ConstrCond = ">", ConstrRHS = 18 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 36, EquipId = equipment.First(e => e.Name == "MRE").ID, ConstrCond = ">", ConstrRHS = 24 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 12, EquipId = equipment.First(e => e.Name == "100oz Hydration System (filled)").ID, ConstrCond = ">", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "FR Gloves, Frog").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Patrol Pack").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "RCO").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Individual First Aid Kit (IFAK)").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Personal Illumination System").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Knee, Elbow Pad Set").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Regular Complete Uniform").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Thermal Binoculars").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Duration (hrs)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "UNIT 1 BAG/ 6 IV'S/ 02 TANK QUESTIONABLE").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Helmet").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Armor Vest w/ SAPPI Plates & Accessories").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Grenade, Hand, G8811 Fragmentation").ID, ConstrCond = ">", ConstrRHS = 12 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 400, EquipId = equipment.First(e => e.Name == "Grenade, Hand, G8811 Fragmentation").ID, ConstrCond = ">", ConstrRHS = 24 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M50 Gas Mask w/ Hood, All Accessories (medium)").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Ballistic Eye Wear").ID, ConstrCond = "=", ConstrRHS = 6 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Service Rifle, M16A4").ID, ConstrCond = "=", ConstrRHS = 4 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M-16 Magazine with 30 Rounds").ID, ConstrCond = "=", ConstrRHS = 28 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M249").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "LBE for M249").ID, ConstrCond = ">", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Cartridge, 5.56 Link (200)").ID, ConstrCond = "=", ConstrRHS = 2 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M9 Pistol").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M9 Magazine with 15 Rounds").ID, ConstrCond = "=", ConstrRHS = 2 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "M203").ID, ConstrCond = "=", ConstrRHS = 2 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Ammunition, Smoke").ID, ConstrCond = "=", ConstrRHS = 2 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Ammunition, Flares").ID, ConstrCond = "=", ConstrRHS = 2 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "PVS-17C").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Optics: PVS-14 (night vision goggles)").ID, ConstrCond = "=", ConstrRHS = 3 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "148").ID, ConstrCond = "=", ConstrRHS = 1 },
				new MissionRule { ParamId = parameters.First(p => p.Name == "Threat level (0-500)").ID, RuleCond = ">", RuleData = 0, EquipId = equipment.First(e => e.Name == "Multi-purpose Bayonet").ID, ConstrCond = "=", ConstrRHS = 3 }
			};
